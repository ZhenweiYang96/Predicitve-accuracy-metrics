...
for (i in 1:200) {
  ...
  true_res <- list(auc_df = auc_df,
                   ...
                   bs_df = bs_df,
                   true_bs = true_bs)
  save(true_res, file = paste0("R script/Simulation/Evaluation/True models/AccMet_true_",
                               i, ".RData"))
}
...
for (i in 1:200) {
  ...
  true_res <- list(auc_df = auc_df,
                   ...
                   bs_df = bs_df,
                   true_bs = true_bs)
  save(true_res, file = paste0("R script/Simulation/Evaluation/True no cov/AccMet_true_",
                               i, ".RData"))
}
...
for (i in 1:200) {
  ...
  true_res <- list(auc_df = auc_df,
                   ...
                   bs_df = bs_df,
                   true_bs = true_bs)
  save(true_res, file = paste0("R script/Simulation/Evaluation/True linear/AccMet_true_",
                               i, ".RData"))
}
...
for (i in 1:200) {
  ...
  save(true_res, file=paste0("R script/Simulation/Evaluation/True models/EPCE_true_", i, ".RData"))
}
...
for (i in 1:200) {
  ...
  true_res <- true_epce(model = icjm, data = train.data, type = "linear", 
                        t = 1, dt = 3, seed = seed[i])
  save(true_res, file=paste0("Simulation/Evaluation/True linear/EPCE_true_", i, ".RData"))
}
...
for (i in 145:200) {
  ...
  true_res <- true_epce(model = icjm, data = train.data, type = "nocovar", 
                        t = 1, dt = 3, seed = seed[i])
  save(true_res, file=paste0("R script/Simulation/Evaluation/True no cov/EPCE_true_", i, ".RData"))
}
